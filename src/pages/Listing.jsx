...
export default function Listing() {
  ...
  return (
    ...
    {shareLinkCopied && (<p className="fixed top-[23%] right-[5%] font-semibold 
    ...
    shadow-lg bg-white lg:space-x-5">
        <div className="w-full h-[200px] lg-[400px]">
            ...
            <div className="flex justify-start items-center space-x-4 w-[75%]">
                ...
                p-1 text-white text-center font-semibold shadow-md">{listing.type === "rent" ? "Rent" : "Sale"}</p>
                {listing.offer && (
                    <p className="w-full maz-w-[200px] bg-green-800 rounded-md
            ...
            <ul className="flex items-center space-x-2 sm:space-x-10 text-sm font-semibold">
                ...
                <li className="flex items-center whitespace-nowrap">
                    ...
                    {+listing.bathrooms > 1 ? `${listing.bathrooms} Bathss` : "1 Bath"}
                </li>
                <li className="flex items-center whitespace-nowrap">
